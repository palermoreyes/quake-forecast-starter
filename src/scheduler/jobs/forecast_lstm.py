...
class Config:
    ...
    train_end: dt.date = dt.date.fromisoformat(os.getenv("SPLIT_TRAIN_END", "2021-12-31"))
    val_end: dt.date = dt.date.fromisoformat(os.getenv("SPLIT_VAL_END", "2023-12-31"))
    test_end: dt.date = dt.date.fromisoformat(os.getenv("SPLIT_TEST_END", "2025-12-31"))
...
def train_and_register(cfg: Config):
    ...
    model_filename = f"model_lstm_v3.3.2_hybrid_{ts}.keras"
